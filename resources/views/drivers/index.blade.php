...
<div class="card">
    <div class="card-head" style="justify-content:space-between;">
        <div style="display:flex;align-items:center;gap:.6rem;">
            ...
            <span class="card-title">Liste des chauffeurs</span>
    ...
    <div style="padding:.85rem 1.25rem;border-bottom:1px solid #f1f5f9;background:#fafafa;">
        <form method="GET" class="filters-bar">
            ...
            @if(request()->anyFilled(['q','status','license','contract','avec_archives']))
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                ...
                @endphp
                <tr style="{{ $driver->trashed() ? 'opacity:.55;' : '' }}">
                    <td>
                    ...
                    <td>
                        ...
                        @if($driver->trashed())<span class="badge" style="background:#fef2f2;color:#dc2626;margin-left:.25rem;">Archivé</span>@endif
                    </td>
                    ...
                    <td>
                        ...
                        @else
                            <span style="color:#94a3b8;font-size:.8rem;">Disponible</span>
                        @endif
                    </td>
                    <td>
                    ...
                    <td style="text-align:right;">
                        <div style="display:flex;justify-content:flex-end;gap:.4rem;">
                            ...
                            <form method="POST" action="{{ route('drivers.restore', $driver->id) }}">
                                @csrf
                                <button type="submit" class="btn btn-ghost" style="padding:.35rem .7rem;color:#10b981;font-size:.78rem;">Restaurer</button>
                            </form>
                            @endcan
                            @endif
                        </div>
                ...
                @empty
                <tr><td colspan="8" style="text-align:center;padding:2.5rem;color:#94a3b8;">Aucun chauffeur trouvé.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
