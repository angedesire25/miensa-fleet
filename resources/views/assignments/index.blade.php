...
<div class="card">
    ...
    <div style="padding:.85rem 1.25rem;border-bottom:1px solid #f1f5f9;background:#fafafa;">
        <form method="GET" style="display:flex;gap:.65rem;flex-wrap:wrap;align-items:flex-end;">
            ...
            @if(request()->anyFilled(['q','status','type','date_from','date_to']))
    ...
    <div style="overflow-x:auto;">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="9" style="text-align:center;padding:2.5rem;color:#94a3b8;">Aucune affectation trouvée.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
